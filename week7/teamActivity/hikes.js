...
let hikeName1 = 'Bechler Falls';
let commnet1 = '123';

let commnetOne = new Commnet(hikeName1, commnet1);
console.log(commnetOne);
const commnets = [
  {
...
function renderCommentList() {
  ...
  getAllComments().forEach((hikeName)=>{
    this.getAllComments().find(hike => hike.name === hikeName)
    {
      item.innerHTML = `<div>
    <h3>Comment</h3>
    <p>${hike.commnet.content}</p>
    </div>`;
    }
  })
}
